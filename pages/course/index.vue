...
export default {
  ...
  methods: {
    ...
    searchOne(id, indexNum) {
      this.oneIndex = indexNum
      this.twoIndex = -1
      ...
      for (let index = 0; index < this.subjectNestedList.length; index++) {
        const subjectId = this.subjectNestedList[index].id;
        if (subjectId == id) {
    ...
    searchTwo(id, indexNum) {
      this.twoIndex = indexNum
